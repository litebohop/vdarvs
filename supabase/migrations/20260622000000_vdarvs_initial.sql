...
INSERT INTO disputes (id, case_number, title, description, complainant_id, respondent_name, village, district, chief_id, category, status, filed_at, resolved_at) VALUES
  ('g0000001-0001-4001-8001-000000000001', 'DSP-2024-001', 'Boundary dispute between Molapo and Seoli families', 'Disagreement over the boundary line between two adjacent homesteads in Masianokeng.', 'b0000001-0001-4001-8001-000000000001', 'Mpho Seoli', 'Masianokeng', 'Maseru', 'a0000001-0001-4001-8001-000000000001', 'boundary', 'under_review', now() - interval '7 days', NULL),
  ('g0000001-0001-4001-8001-000000000002', 'DSP-2024-002', 'Livestock grazing rights on communal land', 'Dispute over grazing access to communal land near Ha Tsolo.', 'b0000001-0001-4001-8001-000000000002', 'Karabo Ntšo', 'Ha Tsolo', 'Maseru', 'a0000001-0001-4001-8001-000000000002', 'livestock', 'pending', now() - interval '4 days', NULL),
  ('g0000001-0001-4001-8001-000000000003', 'DSP-2023-045', 'Land inheritance dispute', 'Family dispute over inheritance of agricultural land parcel.', 'b0000001-0001-4001-8001-000000000006', 'Family Council', 'Maputsoe', 'Leribe', 'a0000001-0001-4001-8001-000000000001', 'land', 'approved', now() - interval '60 days', now() - interval '30 days');

INSERT INTO residency_requests (id, citizen_id, chief_id, status, requested_at) VALUES
  ('h0000001-0001-4001-8001-000000000001', 'b0000001-0001-4001-8001-000000000003', 'a0000001-0001-4001-8001-000000000003', 'pending', now() - interval '3 days'),
  ('h0000001-0001-4001-8001-000000000002', 'b0000001-0001-4001-8001-000000000005', 'a0000001-0001-4001-8001-000000000001', 'pending', now() - interval '1 day');

INSERT INTO notifications (id, user_id, title, message, type, read, href, created_at) VALUES
  ('i0000001-0001-4001-8001-000000000001', 'c0000001-0001-4001-8001-000000000002', 'New residency verification request', 'Lerato Khumalo has submitted a residency verification request for Ha Ramokoatsi.', 'action', false, '/residency', now() - interval '1 day'),
  ('i0000001-0001-4001-8001-000000000002', 'c0000001-0001-4001-8001-000000000002', 'Document pending approval', 'Animal Registration Permit for Mpho Seoli requires your endorsement.', 'warning', false, '/documents', now() - interval '2 days'),
  ('i0000001-0001-4001-8001-000000000003', 'c0000001-0001-4001-8001-000000000003', 'New citizen registration', 'Karabo Ntšo has been registered in Hlotse, pending verification.', 'info', true, '/citizens', now() - interval '1 day'),
  ('i0000001-0001-4001-8001-000000000004', 'c0000001-0001-4001-8001-000000000001', 'System audit completed', 'Monthly audit log review completed for Maseru district.', 'success', true, '/audit-logs', now() - interval '5 days');

INSERT INTO audit_logs (id, user_id, user_name, action, entity, entity_id, details, village, district, created_at) VALUES
  ('j0000001-0001-4001-8001-000000000001', 'c0000001-0001-4001-8001-000000000002', 'Chief Letsie Ramokoatsi', 'APPROVE', 'citizen', 'b0000001-0001-4001-8001-000000000001', 'Approved residency verification for Palesa Molapo', 'Masianokeng', 'Maseru', now() - interval '5 days'),
  ('j0000001-0001-4001-8001-000000000002', 'c0000001-0001-4001-8001-000000000003', 'Mpho Seoli', 'CREATE', 'citizen', 'b0000001-0001-4001-8001-000000000005', 'Registered new citizen Karabo Ntšo', 'Hlotse', 'Leribe', now() - interval '1 day'),
  ('j0000001-0001-4001-8001-000000000003', 'c0000001-0001-4001-8001-000000000001', 'Thabo Mokoena', 'UPDATE', 'settings', 'system', 'Updated notification preferences for Maseru district', NULL, 'Maseru', now() - interval '3 days'),
  ('j0000001-0001-4001-8001-000000000004', 'c0000001-0001-4001-8001-000000000002', 'Chief Letsie Ramokoatsi', 'CREATE', 'dispute', 'g0000001-0001-4001-8001-000000000001', 'Opened boundary dispute case DSP-2024-001', 'Masianokeng', 'Maseru', now() - interval '7 days');
